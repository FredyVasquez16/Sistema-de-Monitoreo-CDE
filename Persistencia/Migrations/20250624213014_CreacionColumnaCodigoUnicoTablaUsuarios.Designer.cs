...
namespace Persistencia.Migrations
{
    ...
    [Migration("20250624213014_CreacionColumnaCodigoUnicoTablaUsuarios")]
    partial class CreacionColumnaCodigoUnicoTablaUsuarios
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dominio.Asesorias", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Dominio.AsesoriasAsesores", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Dominio.AsesoriasContactos", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Dominio.AsesoriasArchivos", b =>
                {
                    b.HasOne("Dominio.Asesorias", "Asesoria")
                        .WithMany("Archivos")
            ...
            modelBuilder.Entity("Dominio.ClientesEmpresas", b =>
                {
                    ...
                    b.HasOne("Dominio.Contactos", "ContactoPrimario")
                        .WithMany()
                    ...
                    b.HasOne("Dominio.Contactos", "NombrePropietario")
                        .WithMany()
            ...
            modelBuilder.Entity("Dominio.SesionesParticipantes", b =>
                {
                    ...
                    b.HasOne("Dominio.Contactos", "Contacto")
                        .WithMany("SesionesParticipantes")
