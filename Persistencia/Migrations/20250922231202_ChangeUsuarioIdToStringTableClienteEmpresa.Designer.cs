...
namespace Persistencia.Migrations
{
    ...
    [Migration("20250922231202_ChangeUsuarioIdToStringTableClienteEmpresa")]
    partial class ChangeUsuarioIdToStringTableClienteEmpresa
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dominio.AsesoriaUnidad", b =>
                {
                    b.Property<int>("AsesoriaId")
                        .HasColumnType("integer")
                        .HasColumnName("asesoria_id");
                    ...
                    b.HasKey("AsesoriaId", "UnidadId");

                    b.HasIndex("UnidadId")
                        .HasDatabaseName("ix_asesorias_unidades_unidad_id");

                    b.ToTable("asesorias_unidades");
                });
            ...
            modelBuilder.Entity("Dominio.AsesoriaUnidad", b =>
                {
                    b.HasOne("Dominio.Asesoria", "Asesoria")
                        .WithMany("AsesoriasUnidades")
                        .HasForeignKey("AsesoriaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_asesorias_unidades_asesorias_asesoria_id");
                    ...
                    b.HasOne("Dominio.Unidad", "Unidad")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_asesorias_unidades_unidades_unidad_id");
            ...
            modelBuilder.Entity("Dominio.Asesoria", b =>
                {
                    ...
                    b.Navigation("AsesoriasUnidades");
                });
